...
mongoose.connect(process.env.MONGO_URI)
  .then(async () => {
    ...
    await Result.insertMany([
      ...
      {
        seat:"J045884",
        mname:"Lakshmi Prashant Irpati",
        name:"Piyush Prashant Irpati",
        division:"A",
        subjects: [
          {code:"03", name:"English", marks:"45" },
          {code:"16", name:"Marathi", marks:"52" },
          {code:"15", name:"Hindi", marks:"55" },
          {code:"71", name:"Mathematics", marks:"50" },
          {code:"72", name:"Science", marks:"48" },
          {code:"73", name:"Social Science", marks:"43" },
        ],
        total:250,
        percentage:50,
        status:"Pass"
